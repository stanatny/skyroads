...
(function attachI18n(root) {
  ...
  const MESSAGES = Object.freeze({
    en: Object.freeze({
      ...
      'controls.move': 'Move: A / D or ← / →', 'controls.jump': 'Jump / glide: K / Space · hold while descending to glide', 'controls.fuelBurst': 'Fuel burst: fuel ≥ 75% + hold W / ↑ for 1s (costs 50% fuel)', 'controls.shoot': 'Fire: tap or hold J', 'controls.touch': 'Swipe to move · tap to jump', 'controls.pause': 'Pause / resume: P',
      ...
      'tutorial.move': 'Swipe ← → or press A/D to switch lanes', 'tutorial.jump': 'Press Space/K to jump', 'tutorial.glide': 'Hold jump key while falling to glide', 'tutorial.shoot': 'Press J to fire missiles', 'tutorial.fuelBurst': 'Fuel ≥75%: HOLD W/↑ for 1s → FUEL BURST!', 'tutorial.progress': 'TRAINING {current}/{total}',
    ...
    'zh-CN': Object.freeze({
      ...
      'controls.move': '移动：A / D 或 ← / →', 'controls.jump': '跳跃 / 滑翔：K / Space · 下落时按住即可滑翔', 'controls.fuelBurst': '燃料爆发：燃料 ≥ 75% 时按住 W / ↑ 1 秒（消耗 50% 燃料）', 'controls.shoot': '射击：点按或按住 J', 'controls.touch': '左右滑动变道 · 点按跳跃', 'controls.pause': '暂停 / 继续：P',
      ...
      'tutorial.move': '左右滑动或按 A/D 变道', 'tutorial.jump': '按 Space/K 跳跃', 'tutorial.glide': '下落时按住跳跃键可滑翔', 'tutorial.shoot': '按 J 发射导弹', 'tutorial.fuelBurst': '燃料≥75%：按住 W/↑ 1 秒触发燃料爆发！', 'tutorial.progress': '教学 {current}/{total}',
