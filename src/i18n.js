...
(function attachI18n(root) {
  ...
  const MESSAGES = Object.freeze({
    en: Object.freeze({
      ...
      'controls.move': 'Move: A / D or ← / →', 'controls.jump': 'Jump / glide: K / Space / W / ↑ · hold while descending to glide', 'controls.shoot': 'Fire: tap or hold J', 'controls.touch': 'Swipe to move · tap to jump',
    ...
    'zh-CN': Object.freeze({
      ...
      'controls.move': '移动：A / D 或 ← / →', 'controls.jump': '跳跃 / 滑翔：K / Space / W / ↑ · 下落时按住即可滑翔', 'controls.shoot': '射击：点按或按住 J', 'controls.touch': '左右滑动变道 · 点按跳跃',
