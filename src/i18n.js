...
(function attachI18n(root) {
  ...
  const MESSAGES = Object.freeze({
    en: Object.freeze({
      'app.documentTitle': 'Nebula Cruise', 'app.versionLabel': 'Version {version}', 'meta.description': 'A fast sci-fi lane runner through an endless nebula.', 'canvas.label': 'Nebula Cruise game canvas', 'language.switchToChinese': '中文', 'language.switchToEnglish': 'EN',
      'menu.title': 'NEBULA CRUISE', 'menu.subtitle': 'INTERSTELLAR COMMAND', 'menu.start': 'Start Mission', 'menu.tutorial': 'Training', 'menu.leaderboard': 'Local Top 15', 'shortcut.startRestart': 'Enter / Space', 'shortcut.returnMenu': 'Esc',
      'controls.move': 'Move: A / D or ← / →', 'controls.jump': 'Jump / glide: K / Space · hold while descending to glide', 'controls.fuelBurst': 'Fuel burst: fuel ≥ 70% + hold W / ↑ for 1s (costs 40% fuel)', 'controls.shoot': 'Fire: tap or hold J', 'controls.touch': 'Swipe to move · tap to jump', 'controls.pause': 'Pause / resume: P',
      'guide.routes': '1 cyan band: one jump · 2 bands: two jumps · gold beacon: super-form third jump · lit corridor: jump, then hold while descending · every advanced route has an ordinary bypass lane',
      ...
      'status.chargeIdle': 'MISSILE CHARGE', 'status.charging': 'CHARGING {percent}%', 'status.chargeReady': 'MISSILE READY', 'status.boost': 'BOOST {seconds}s', 'status.boostWarning': 'BOOST ENDING {seconds}s', 'status.fuelBurst': 'FUEL BURST {seconds}s', 'status.fuelBurstWarning': 'FUEL BURST ENDING {seconds}s', 'status.super': 'SUPER FORM {seconds}s', 'status.superWarning': 'SUPER ENDING {seconds}s', 'status.magnet': 'MAGNET {seconds}s', 'effect.superForm': '★ SUPER FORM ★',
      'tutorial.move': 'Swipe ← → or press A/D to switch lanes', 'tutorial.jump': 'Press Space/K to jump', 'tutorial.glide': 'Hold jump key while falling to glide', 'tutorial.shoot': 'Press J to fire missiles', 'tutorial.fuelBurst': 'Fuel ≥70%: HOLD W/↑ for 1s → FUEL BURST!', 'tutorial.progress': 'TRAINING {current}/{total}',
      ...
      'pause.title': 'GAME PAUSED', 'pause.resumeHint': 'Press P to resume',
      'wormhole.capture': 'CAPTURE', 'wormhole.tear': 'SPACE TEAR', 'wormhole.tunnel': 'IN TRANSIT', 'wormhole.exit': 'RE-ENTRY', 'wormhole.complete': 'WARP COMPLETE', 'wormhole.noDrain': 'NO DRAIN · POWER-UP TIMERS PAUSED',
      'wormhole.reward': 'DISTANCE GAIN', 'wormhole.credited': 'ADDED TO TOTAL DISTANCE',
    ...
    'zh-CN': Object.freeze({
      'app.documentTitle': '星云巡航', 'app.versionLabel': '版本 {version}', 'meta.description': '驾驶飞船穿越无尽星云的高速科幻跑酷游戏。', 'canvas.label': '星云巡航游戏画面', 'language.switchToChinese': '中文', 'language.switchToEnglish': 'EN',
      'menu.title': '星云巡航', 'menu.subtitle': '星际指挥中心', 'menu.start': '开始任务', 'menu.tutorial': '新手教学', 'menu.leaderboard': '本机 Top 15', 'shortcut.startRestart': 'Enter / Space', 'shortcut.returnMenu': 'Esc',
      'controls.move': '移动：A / D 或 ← / →', 'controls.jump': '跳跃 / 滑翔：K / Space · 下落时按住即可滑翔', 'controls.fuelBurst': '燃料爆发：燃料 ≥ 70% 时按住 W / ↑ 1 秒（消耗 40% 燃料）', 'controls.shoot': '射击：点按或按住 J', 'controls.touch': '左右滑动变道 · 点按跳跃', 'controls.pause': '暂停 / 继续：P',
      'guide.routes': '1 条青色灯带：一段跳 · 2 条灯带：二段跳 · 金色信标：超级形态三段跳 · 发光连排：起跳后在下落时按住 · 每条进阶路线都有普通绕行车道',
      ...
      'status.chargeIdle': '导弹蓄力', 'status.charging': '蓄力中 {percent}%', 'status.chargeReady': '导弹就绪', 'status.boost': '超级加速 {seconds}秒', 'status.boostWarning': '加速即将结束 {seconds}秒', 'status.fuelBurst': '燃料爆发 {seconds}秒', 'status.fuelBurstWarning': '爆发即将结束 {seconds}秒', 'status.super': '超级形态 {seconds}秒', 'status.superWarning': '形态即将结束 {seconds}秒', 'status.magnet': '磁铁 {seconds}秒', 'effect.superForm': '★ 超级形态 ★',
      'tutorial.move': '左右滑动或按 A/D 变道', 'tutorial.jump': '按 Space/K 跳跃', 'tutorial.glide': '下落时按住跳跃键可滑翔', 'tutorial.shoot': '按 J 发射导弹', 'tutorial.fuelBurst': '燃料≥70%：按住 W/↑ 1 秒触发燃料爆发！', 'tutorial.progress': '教学 {current}/{total}',
      'gameover.title': '任务结束', 'death.wall': '撞上障碍物', 'death.gap': '坠入虚空', 'death.fuel': '燃料耗尽', 'death.enemy': '撞上敌机', 'death.default': '任务结束',
      'pause.title': '游戏已暂停', 'pause.resumeHint': '按 P 继续',
      'wormhole.capture': '引力捕获', 'wormhole.tear': '撕开空间', 'wormhole.tunnel': '时空穿梭', 'wormhole.exit': '返回航道', 'wormhole.complete': '折跃完成', 'wormhole.noDrain': '能量零消耗 · 增益计时暂停',
      'wormhole.reward': '额外航程', 'wormhole.credited': '已计入总航程',
