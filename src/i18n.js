...
(function attachI18n(root) {
  ...
  const MESSAGES = Object.freeze({
    en: Object.freeze({
      ...
      'settings.musicOn': 'MUSIC ON', 'settings.musicOff': 'MUSIC OFF', 'settings.sfxOn': 'SFX ON', 'settings.sfxOff': 'SFX OFF',
    ...
    'zh-CN': Object.freeze({
      ...
      'settings.musicOn': '音乐开启', 'settings.musicOff': '音乐关闭', 'settings.sfxOn': '音效开启', 'settings.sfxOff': '音效关闭',
